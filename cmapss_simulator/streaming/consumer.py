...
# 🐍 LEAD DE ORCHESTRATION: Spark 4.1.1 Environment
...
def main():
    logger.info("Initializing Finalized Spark Session (Spark 4.1.1 Earliest Mode)...")

    # 🚀 LEAD DE CONFIGURATION
    ...
    logger.info("Subscribing to Stream (Full History Replay)...")

    # Read stream (Changed to earliest)
